...
/**
 *  Person
 *  Write a class with the Person. The class needs three fields (instance variables) with the names
 *  firstName, lastName of type String and age of type int.
 *  Write the following method (instance methods) :
 * * Method named getFirstName without any parameters, it needs to return the value of the firstName field.
 * * Method named getLastName without any parameters, it needs to return the value of the lastName field.
 * * Method named getAge without any parameters, it needs to return the value of the age filed.
 * * Method setFirstName with one parameter of type String, it needs to set the value of the firstName field.
 * * Method setLastName with one parameter of type String, it needs to set the value of the lastName field.
